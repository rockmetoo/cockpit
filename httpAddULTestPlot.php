<?php
	...
	// Include the form
	include('forms/httpAddULTestPlot.php');
	...
	$js_string =
		'$(function()
		{
			$(".addOnceMore").live("click", function(e)
			{
				...
				window.location = "httpAddULTestPlot.php";
			});
			...
			$(".backToTriggerList").live("click", function(e)
			{
				...
				window.location = "httpTriggerULTestPlot.php";
			});
			
			checkUploadFileSize("Upload file size exceed 10MB", "Alert!");
		});';
...
?>
		...
		<?php
			$breadcrumb_data = array('controlPanel.php' => $lang->get('my dashboard') , $_SERVER['REQUEST_URI'] => 'Add a Http Upload Test Plot');
		?>
					...
					if($processor->error_no == 1)
					{
						echo
							'<div class="success content_notice transparent">
								<img src="../images/successful.png"></img>Http Upload Test Plot Created Successfully
							</div><br/>
