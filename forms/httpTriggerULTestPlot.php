<?php
	...
	$allHttpTestPlotName = '<table class="theTable">' . CDBHttpTestPlot::getAllHttpULTestPlotHtmlNameByUserId() . '</table>';
	
	$form_contents = new Form("httpTriggerULTestPlotForm");
	$form_contents->configure(array("action" => "httpTriggerULTestPlot.php", "method" => "post"));
