...
?>
		...
		<div class="employer_full_content">
			<div class="form_holder">
				<?php
					CDBHttpTestPlot::deleteHttpULTestPlot($_REQUEST['plotName']);
					
					echo
					'<div class="success content_notice transparent">
							<img src="../images/successful.png"></img>Upload Test Plot Deleted Successfully
					</div><br/>
					<button class="register_black undoHttpTestPlotDeletion" type="submit" id="' . $_REQUEST['plotName'] . '" name="undo">Undo</button>
					<button class="register_black backToTriggerList" type="submit" name="backToTriggerList">Back To Upload Test Plot</button>';
				?>
			</div>
		</div>
	<?php
