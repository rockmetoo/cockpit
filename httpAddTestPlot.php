<?php
	...
	// Include the form
	include('forms/httpAddTestPlot.php');
	...
	$js_string =
		'$(function()
		{
			...
			$(".addOnceMore").live("click", function(e)
			{
				...
				window.location = "httpAddTestPlot.php";
			});
...
?>
		...
		<?php
			$breadcrumb_data = array(
				...
				, $_SERVER['REQUEST_URI'] => 'Add a Http Test Plot'
			);
		?>
					...
					if($processor->error_no == 1)
					{
						echo
							'<div class="success content_notice transparent">
								<img src="../images/successful.png"></img>Http Test Plot Created Successfully
							</div><br/>
