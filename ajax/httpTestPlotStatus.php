<?php
	...
	$status = CDBHttpTestPlot::getHttpTestPlotStatusByName($plotName);
	...
	else if($status == 4)
	{
		...
		$jsonData = array(
			"val" => $status,
			"message" => "<img src='../images/warning.png'></img>&nbsp;Host ownership not confirmed&nbsp;<a href='hostOwnerShipFile.php?fileName=" . $fileName . "&amp;plotName=" . $plotName . "' target='_blank'>[Upload this file]</a>"
		);
