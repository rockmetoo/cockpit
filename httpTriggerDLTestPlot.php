<?php
	...
	// Include the form
	include 'forms/httpTriggerDLTestPlot.php';
	...
	'$(function()
	{
		httpDLTestPlotFormSubmit();
		httpDLTestPlotStatusCheck();
		httpDLPlotConfigToolTip();
		
		checkHttpDLHostOwnershipFile();
		httpDLPlotEdit();
		httpDLPlotDelete("Alert!", "Are you sure you want to delete this plot: ");
	});';
