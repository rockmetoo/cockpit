<?php
	...
	// Include the form
	include('forms/tcpAddTestPlot.php');
	...
	$js_string =
		'$(function()
		{
			$(".addOnceMore").live("click", function(e)
			{
				...
				window.location = "tcpAddTestPlot.php";
			});
			...
			$(".backToTriggerList").live("click", function(e)
			{
				...
				window.location = "tcpTriggerTestPlot.php";
			});
		});';
...
?>
		...
		<?php
			$breadcrumb_data = array('controlPanel.php' => $lang->get('my dashboard'), $_SERVER['REQUEST_URI'] => 'Add a TCP Test Plot');
		?>
					...
					if($processor->error_no == 1)
					{
						echo
							'<div class="success content_notice transparent">
								<img src="../images/successful.png"></img>TCP Test Plot Created Successfully
							</div><br/>
							<button class="register_black addOnceMore" type="submit" name="backToEdit">Add Once More</button>
							<button class="register_black backToTriggerList" type="submit" name="backToTriggerList">Back To TCP Test Plot</button>';
					}
					else
					{
						//Output form
