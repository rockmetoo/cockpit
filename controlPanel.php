<?php
	...
	foreach($EC_CONTROL_PANEL as $section => $section_text)
	{
		...
		foreach($EC_CONTROL_PANEL_SUB[$section] as $content_link => $content_text)
		{
		...
		<div class="employer_full_content">
			<div class="form_holder">
						...
						<ul id="list1">
							<?php
								...
								foreach($quickLinkColumnsRearrange[0] as $section)
								{
									...
									if($section == 'tcpTestPlot' || $section == 'udpTestPlot')
									{
							...
							?>
										<li>
											...
											<div class="curved_230">
												<div class="leftmenu">
													<h3 style="color:<?php echo $QUICK_LINK_COLUMNS[0][$section]; ?>;"><?php echo $text; ?></h3>
											<?php
				...
				<div class="testerDasboardQuickStat">
					<h2><span><?php echo $lang->get('total threads ruuning'); ?></span></h2>
					<div class="testerDasboardHolder">
