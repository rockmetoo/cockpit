<?php
	...
	$MY_AVAILABLE_SERVICE = CDBUser::getMachineDataServiceACL($SMITH_SYSTEM_DEF['userId']);
	
	/********************* Reseource Allocation ****************************/

	// Rearrange Employer dashboard according to their change of widget
	$quickLinkColumnsRearrange = CDBUser::rearrangeMachineDataDashboard($SMITH_SYSTEM_DEF['userId'], array_keys($MY_AVAILABLE_SERVICE));
